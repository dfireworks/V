# 使用Railway'(https://railway.app)'部署Xray高性能代理服务，通过ws传输的 (vmess、vless、trojan shadowsocks、socks)等协议
...
* **务必替换所有的`b1d4b893-6151-4ef9-b5c5-b69dcce1aa26`为部署时设置的UUID,建议更改,不要每个人都一样**  
...
* 端口：443
* 默认UUID：b1d4b893-6151-4ef9-b5c5-b69dcce1aa26
* vmess额外id：0
* 加密：none
* 传输协议：ws
* 伪装类型：none
* 伪装域名：xxx.workers.dev(CF Workers反代地址)
* 路径：/vless // 默认vless使用(/vless)，vmess使用(/vmess)
* 底层传输安全：tls
* 跳过证书验证：false
```
</details>
...
* 客户端下载: https://github.com/p4gefau1t/trojan-go/releases
{
    ...
    "remote_port": 443,
    "password": [
        "b1d4b893-6151-4ef9-b5c5-b69dcce1aa26"
    ],
    "websocket": {
        "enabled": true,
        "path": "/trojan",
